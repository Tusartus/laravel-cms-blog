...
@section('content')
			...
			<section class="banner-area relative" id="home" data-parallax="scroll" data-image-src="{{asset('bloger/img/header-bg.jpg')}}">
...
<section class="fashion-area section-gap" id="fashion">
  <div class="container">
    ...
    <?php
    $textline = "Fashion News This Week from variable";
    $allpost = "All Posts"
    ...
    <div class="row d-flex justify-content-center">
      <div class="menu-content pb-70 col-lg-8">
        <div class="title text-center">
          <h1 class="mb-10"> 	{{ $tag->name }} </h1>
          <p class="mb-10"> <?php echo $allpost;?> from {{ $tag->name }}</p>
        </div>
      </div>
    </div>
