                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active mr-3">
                                <a href="#profile_with_icon_title" data-toggle="tab">
                                    <i class="material-icons text-dark"></i> UPDATE PROFILE
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#change_password_with_icon_title" data-toggle="tab">
                                    <i class="material-icons text-dark"></i> CHANGE PASSWORD
                                </a>
                            </li>
                                ...
                                <form method="POST" action="{{ route('admin.profile.update') }}" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                            <button type="submit" class="btn btn-primary m-t-15 waves-effect ml-3">UPDATE</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
